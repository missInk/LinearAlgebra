...
public class MailUtil implements Runnable{
	...
	public void run() {
		...
		// 3.发送一封激活邮件
		String from = "2453671898@qq.com";// 发件人电子邮箱
		...
		try {
			...
			// 2.4设置邮件内容
			String content = "<html><head></head><body><h1>这是一封激活邮件,激活请点击以下链接</h1><h3><a href='http://localhost:8080/LinearAlgebra/ActiveServlet?code="
